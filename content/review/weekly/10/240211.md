...
location: "湖南长沙"
img_url: https://pic.shaojiemike.top/shaojiemike/2024/02/3ba58d3b4edecec375fe39ca6548bc98.png
health_img: 
onlineLink: 
abstract: "老家过春节准备"
KeyWords:
...
2. Tues：Working from home during the Chinese New Year is distracting.
3. Wed：Working from home during the Chinese New Year is distracting.
4. Thurs： Working from home during the Chinese New Year is distracting.
5. Fri: 除夕
6. Sat: Honkai Star Rail: Penacony
7. Sun：初二高桥拜年
...
7. 回家准备 [notion](https://shaojiemike.notion.site/0d7bcd7e4cf1420580fcd7f70ecd95b5?pvs=4)
   1. 当天物品和退宿请求留电：
   2. 软件更新(提前一天)：
   3. 网络服务支持(提前两天测试)：
   4. 硬件(提前两天拿回宿舍)：
